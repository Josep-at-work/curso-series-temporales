...
x; y # Se obtiene lo mismo, pero que hay detrás de esto? 
...
# Es la cantidad de segundos que hay hasta esa fecha, desde el punto de referencia 01-01-1970 00:00:00(no considera los años bisiestos):
...
## También se puede calcular el d?a de la semana que corresponde a nuestra fecha
